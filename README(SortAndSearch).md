...
**Сложность:** O(n²) - квадратичная. два вложенных цикла, каждый размером ~n
...
**Сложность:**
- O(n²) - в худшем случае.два вложенных цикла, но в лучшем случае O(n)
...
**Сложность:**
- O(n²) - в среднем случае.для каждого элемента может потребоваться сдвиг всех предыдущих
...
**Сложность:** O(n log n) - гарантированная. массив делится пополам log n раз, каждое слияние O(n)
...
**Сложность:**Сложность: O(n log n) - O(n²) зависит от последовательности шагов
**Результат выполения:**
...
**Сложность:**
Сложность: O(n log n) - построение кучи O(n), n извлечений по O(log n)
...
**Сложность:** Сложность: O(log n) - на каждом шаге область поиска уменьшается вдвое
...
Сложность: O(log log n) для равномерного распределения, O(n) в худшем случае
**Резултат выполнения:**
...
**Сложность:** O O(log n) - аналогично би(log n) - аналогично бинарному поискунарному поиску
